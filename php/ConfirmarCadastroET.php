		...
		if($linha['ic_conta_ativa'] != 1)
		{
			...
			<html>
				...
				<body style="background-color: #fafafa;">
					...
					<label class="at-mensagem" style="display: inline-block;width: 90%;padding-left: 5%;padding-right: 5%;margin-top: 30px;font-size: 1em;color: #333;text-align: justify;line-height: 170%;">Parabéns! Sua conta no EletronTech foi criada com sucesso! Agora você pode aproveitar todos as nossas ferramentas e realizar diversos cálculos. Abaixo estão os dados referentes ao seu perfil.</label>
